        ...
        "/api/v1/roles/{id}/permissions": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdatePermissionsRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Permission UUIDs to remove",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/users/{id}/image": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Not Found - User or profile image not found",
                        "schema": {
                            "$ref": "#/definitions/response.ApiResponse"
                        }
                    },
        ...
        "/api/v1/users/{id}/roles": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Role UUIDs to remove",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
